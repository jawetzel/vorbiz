...
export default function LocationDetailScreen() {
                ...
                try {
                    ...
                    if (fetchedLocation) {
                        setLocation({
                            ...
                            localTaxZone: fetchedLocation.localTaxZone || '',
                            localTaxRate: fetchedLocation.localTaxRate || 0.0,
    ...
    const fieldDisplayNames: Record<string, string> = {
        ...
        localTaxZone: 'Local Jurisdiction (Tax Zone)',
        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.group}>
                ...
                {[
                    ...
                    'phone', 'email',
                    'state', 'countyParish',
                    'localTaxZone', 'localTaxRate', 'stateTaxRate',
