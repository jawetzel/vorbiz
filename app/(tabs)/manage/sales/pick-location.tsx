...
import {StyleSheet, TouchableOpacity, View, Text, ListRenderItemInfo, Linking, FlatList, Modal} from 'react-native';
...
type LocationPickerProps = {
    setLocationId: (data: LocationModel) => void;
    showModal: boolean;
    onClose: () => void;
};

const LocationPickerModal = (props: LocationPickerProps) => {
    ...
    return (
        <Modal visible={props.showModal} animationType="slide" onRequestClose={props.onClose}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }: ListRenderItemInfo<LocationModel>) => (
                        <TouchableOpacity
                            ...
                            onPress={() => props.setLocationId(item)}
                        >
